    ...
    if (search && search.trim()) {
      ...
      filter[Op.and].push({
        [Op.or]: [
          ...
          { client_ref_id: { [Op.like]: `%${searchTerm}%` } },
...
v1Router.get("/work-orders", authenticateJWT, async (req, res) => {
  try {
    ...
    if (search && search.trim()) {
      ...
      filter[Op.and].push({
        [Op.or]: [
          { work_order_generate_id: { [Op.like]: `%${searchTerm}%` } },
          { status_wo: { [Op.like]: `%${searchTerm}%` } },
...
v1Router.get("/sku-details", authenticateJWT, async (req, res) => {
  try {
    ...
    if (search && search.trim()) {
      ...
      filter[Op.and].push({
        [Op.or]: [
          { sku_id: { [Op.like]: `%${searchTerm}%` } },
          { sku_name: { [Op.like]: `%${searchTerm}%` } },
          { description: { [Op.like]: `%${searchTerm}%` } }
        ]
      });
    }
    ...
    if (search && search.trim()) {
      ...
      filter[Op.and].push({
        [Op.or]: [
          ...
          { return_reason: { [Op.like]: `%${searchTerm}%` } },
...
v1Router.get("/credit-notes", authenticateJWT, async (req, res) => {
  try {
    ...
    if (search && search.trim()) {
      ...
      filter[Op.and].push({
        [Op.or]: [
          { credit_note_number: { [Op.like]: `%${searchTerm}%` } },
          { reference: { [Op.like]: `%${searchTerm}%` } },
...
v1Router.get("/debit-notes", authenticateJWT, async (req, res) => {
  try {
    ...
    if (search && search.trim()) {
      ...
      filter[Op.and].push({
        [Op.or]: [
          { debit_note_number: { [Op.like]: `%${searchTerm}%` } },
          { vendor_name: { [Op.like]: `%${searchTerm}%` } },
          { reference: { [Op.like]: `%${searchTerm}%` } },
          { reason: { [Op.like]: `%${searchTerm}%` } },
          { status: { [Op.like]: `%${searchTerm}%` } }
...
v1Router.get("/stock-adjustments", authenticateJWT, async (req, res) => {
  try {
    ...
    if (search && search.trim()) {
      ...
      filter[Op.and].push({
        [Op.or]: [
          { adjustment_id: { [Op.like]: `%${searchTerm}%` } },
          { adjustment_type: { [Op.like]: `%${searchTerm}%` } },
          { reference: { [Op.like]: `%${searchTerm}%` } },
          { reason: { [Op.like]: `%${searchTerm}%` } },
          { status: { [Op.like]: `%${searchTerm}%` } }
        ]
