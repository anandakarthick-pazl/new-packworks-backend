...
export const validateRegister = (req, res, next) => {
  const schema = Joi.object({
    ...
    contract_end_date: Joi.date()
      ...
      .allow(null)
      .default(() => new Date()),
    internship_end_date: Joi.date()
      .optional()
      .allow(null)
      .default(() => new Date()),
    marriage_anniversary_date: Joi.date()
      .optional()
      .allow(null)
      .default(() => new Date()),
    notice_period_end_date: Joi.date()
      .optional()
      .allow(null)
      .default(() => new Date()),
    notice_period_start_date: Joi.date()
      .optional()
      .allow(null)
      .default(() => new Date()),
  ...
  const { error, value } = schema.validate(req.body, {
    abortEarly: false,
    allowUnknown: false, // ✅ You can change this to `true` if you want to allow additional unknown fields
  });
  if (error) {
    return res
      .status(400)
