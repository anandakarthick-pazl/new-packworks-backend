...
const PurchaseOrderReturnItem = sequelize.define(
...
PurchaseOrderReturnItem.belongsTo(CompanyAddress, {
  foreignKey: "company_branch_id",
  as: "branch",
});
PurchaseOrderReturnItem.belongsTo(User, {
...
PurchaseOrderReturnItem.addHook("afterFind", (result) => {
