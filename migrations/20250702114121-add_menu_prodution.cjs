...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.sequelize.query(`
      ...
      VALUES
        ('Order Management', 'data_transfer', 'Data Transfer', 0, 1, '2025-02-25 05:37:39', '2025-02-25 05:38:52', 'active', NULL, NULL)
    `);
    const [result] = await queryInterface.sequelize.query(`
      SELECT id FROM modules WHERE module_name = 'data_transfer'
    `);
    ...
    await queryInterface.sequelize.query(`
      ...
      VALUES 
        ('add_data_transfer', 'Add Data Transfer', ${moduleId}, 1, '{"all":4, "none":5}', '2025-02-25 11:07:41', '2025-02-25 11:07:41', 'active', 1)
    `);

    // Get the inserted permission's ID
    const [results] = await queryInterface.sequelize.query(`
      SELECT id FROM permissions WHERE name = 'add_data_transfer' AND module_id = ${moduleId}
    `);
